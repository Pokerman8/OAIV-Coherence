...
def test(args):
    ...
    model_path = "/inspurfs/group/gaoshh/jinjiping/UDIS2/composition/pretrainOn5withdynamicloss/epoch100_model.pth"
    checkpoint = torch.load(model_path)
    net.load_state_dict(checkpoint['model'])
    print('load model from {}!'.format(model_path))


    path_learn_mask1 = '/inspurfs/group/gaoshh/jinjiping/UDIS2/composition/test-result-jjp5withdynamicloss/learn_mask1/'
    if not os.path.exists(path_learn_mask1):
        os.makedirs(path_learn_mask1)
    path_learn_mask2 = '/inspurfs/group/gaoshh/jinjiping/UDIS2/composition/test-result-jjp5withdynamicloss/learn_mask2/'
    if not os.path.exists(path_learn_mask2):
        os.makedirs(path_learn_mask2)
    path_final_composition = '/inspurfs/group/gaoshh/jinjiping/UDIS2/composition/test-result-jjp5withdynamicloss/composition/'
...
if __name__=="__main__":
    ...
    parser.add_argument('--test_path', type=str, default='/inspurfs/group/gaoshh/jinjiping/UDIS2/UDIS-D/testing/jjp-icassp-dataset')
