...
class TrainDataset(Dataset):
    def __init__(self, data_path):
        ...
        for data in sorted(datas):
            ...
            if data_name == 'warp1' or data_name == 'warp2' or data_name == 'mask1' or data_name == 'mask2' or data_name == 'overlap-mask1+2':
                self.datas[data_name] = {}
                self.datas[data_name]['path'] = data
                self.datas[data_name]['image'] = sorted(glob.glob(os.path.join(data, '*.jpg')) + 
    ...
    def __getitem__(self, index):
        ...
        # load boject_mask1
        object_mask1 = cv2.imread(self.datas['overlap-mask1+2']['image'][index])
